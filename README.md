...
```
src/
├── analysis/       # Corner detection, preprocessing and curve_visualizer.py
├── models/         # AutoEncoder/VAE, dataset_loader.py (with HF download)
└── scripts/        # train.py, evaluate.py
data/
└── dataset/        # Normalized datasets and documentation
```
